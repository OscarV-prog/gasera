...
function OrderCard({ order }: { order: any }) {
  ...
  return (
    <Link
      ...
      className="group block cursor-pointer rounded-lg border border-gray-200 bg-white p-3 shadow-sm transition-all hover:border-blue-500 hover:shadow-md dark:border-gray-700 dark:bg-gray-900"
    >
