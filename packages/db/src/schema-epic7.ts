...
export const UpdateSyncQueueSchema = CreateSyncQueueSchema.partial().extend({
  id: z.string(),
});
 ...
 */
export const CreateRouteIncidentSchema = z.object({
  description: z.string().min(10).max(2000),
  photoUrls: z.string().optional(),
});

export const UpdateRouteIncidentSchema =
  CreateRouteIncidentSchema.partial().extend({
    id: z.string(),
  });
...
export const UpdateOrderDeliverySchema =
  CreateOrderDeliverySchema.partial().extend({
    id: z.string(),
  });
